...
$stmt = $conexion->prepare("SELECT m.materia, m.id_materia, c.curso FROM materias as m INNER JOIN cursos as c ON m.id_curso = c.id_curso INNER JOIN profesores as p ON m.id_profesor = p.id_profesor WHERE p.dni = :dni");
            ...
            <ul class="cards">
                <?php foreach ($materias as $materia): ?>
                    <li data-materia="<?= $materia['materia'] ?>">
                        <a href="notas.php?id=<?= $materia['id_materia'] ?>">
